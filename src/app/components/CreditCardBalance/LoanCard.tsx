...
const LoanCard: React.FC<LoanCardProps> = ({
  ...
  return (
    <div className={`bg-white rounded-lg shadow-md p-6 w-full ${className}`}>
      ...
      <hr className="mb-4"/>
      <div className="mb-4">
        <p className="text-2xl font-semibold text-black">{accountNumber}</p>
        <p className="text-gray-800">Account Number</p>
      </div>
      <div className="mb-4">
        <p className="text-2xl font-semibold text-black">{formatCurrency(totalAmount)}</p>
